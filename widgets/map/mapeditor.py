...
class MapEditor(SphereEditor):
	...
	def setupToolbar(self):
		...
		self.pencil1 = self.pencilMenu.addAction(QIcon(":/icons/res/1x1grid.png"), "1x1")
		self.pencil3 = self.pencilMenu.addAction(QIcon(":/icons/res/3x3grid.png"), "3x3")
		self.pencil5 = self.pencilMenu.addAction(QIcon(":/icons/res/5x5grid.png"), "5x5")
		...
		self.pencilTool.setIcon(QIcon(":/icons/res/pencil.png"))
		...
		self.lineTool = self.menuBar.addAction(QIcon(":/icons/res/linetool.png"), "Line")
		self.lineTool.setCheckable(True)
		self.rectTool = self.menuBar.addAction(QIcon(":/icons/res/rectangletool.png"), "Rectangle")
		self.rectTool.setCheckable(True)
		self.fillTool = self.menuBar.addAction(QIcon(":/icons/res/paintbucket.png"), "Fill layer")
		self.fillTool.setCheckable(True)
		self.dropperTool = self.menuBar.addAction(QIcon(":/icons/res/dropper.png"), "Select tile")
		self.dropperTool.setCheckable(True)
		self.menuBar.addSeparator()
		self.gridTool = self.menuBar.addAction(QIcon(":/icons/res/togglegrid.png"), "Show/Hide grid")
		self.gridTool.setCheckable(True)
		self.showSpritesetsTool = self.menuBar.addAction(QIcon(":/icons/res/show_spritesets.png"), "Show/hide spritesets (not yet implemented)")
